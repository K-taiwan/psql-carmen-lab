...
SELECT name, code, population, code2 FROM country
WHERE region = 'Southern Europe' ORDER BY population LIMIT 1;
...
SELECT code, name, continent, capital FROM country
WHERE code = 'BRA';
...
no clue what this is.... what is landing dock
...
-- She's in ___SANTA MONICA USA___________________!
